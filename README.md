...
8. Fermer complètement la PWA puis la rouvrir pour charger le cache V2.5.2.
...
- `CHANGELOG-V2.5.2.md` : contenu détaillé de la release ;
- `TESTS-V2.5.2.md` : validations exécutées ;
- `EDITION-FIGEE.md` : règles de maintenance après clôture ;
- `docs/INSTALLATION-V2.5.2.md` : procédure de déploiement détaillée.
